...
wilson_path="/home/clusters/rrcmpi/kudrov/smearing_cluster/smearing_test/result/potential/${monopole}/${conf_type}/${conf_size}/${smearing}/mu${mu}/${chain}"
mkdir -p ${wilson_path}
wilson_path="${wilson_path}/wilson_loops_$a$b$c$d"

if [ ! -f ${wilson_path} ] || [ ${calculate_absent} == "false" ]; then
...
/home/clusters/rrcmpi/kudrov/smearing_cluster/code/exe/smearing_dependence_potential1_${matrix_type} $parameters
