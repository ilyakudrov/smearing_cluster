...
mkdir -p ${output_path}
wilson_path="${output_path}/wilson_loops_$a$b$c$d"

parameters="-conf_format $conf_format -conf_path $conf_path -HYP_alpha1 $HYP_alpha1 -HYP_alpha2 $HYP_alpha2 -HYP_alpha3 $HYP_alpha3 -bites_skip $bites_skip\
